...
function MinimalProductCard({ product, onViewProduct, onAddToCart, onQuickView, compact = false }) {
  ...
  return (
    <div 
      className="group relative bg-white rounded-xl border border-gray-200 overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 w-[280px] h-[380px] cursor-pointer card"
      onClick={() => onViewProduct(product.id)}
    >
      {/* Enhanced Image Container with Neutral Background for Clothing */}
