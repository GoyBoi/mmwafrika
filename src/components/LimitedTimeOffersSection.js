    ...
    <div className="py-12 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Limited Time Offers</h2>
          <p className="text-gray-600 mb-4">Special deals ending soon</p>
            ...
            <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="bg-red-100 text-red-800 text-sm font-bold px-2.5 py-0.5 rounded-full">
                    {offer.discount} OFF
                  </span>
                </div>
                ...
                <button 
                  className="w-full mt-6 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-medium py-3 px-4 rounded-lg transition-all duration-300 shadow-sm hover:shadow-md"
